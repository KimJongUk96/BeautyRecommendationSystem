...
<%-- 						<div class="form-group">
						...
						<div class="form-group mb-3" id="method4">
							<label for="simpleinput">세안법4</label>
							<c:forEach items="${detailList}" var="methodDetailVO" varStatus="status">
							<c:if test="${status.count eq '4'}">
							<textarea class="form-control" name="method" rows="5"
								placeholder="Step4 세안법" readonly="readonly" style="font-weight:bold;font-size:12pt;">${methodDetailVO.method}</textarea>
							</c:if>
								</c:forEach>
						</div>
						...
						<div class="form-group mb-3" id="method5">
							...
							<textarea class="form-control" name="method" rows="5"
								placeholder="Step5 세안법" readonly="readonly" style="font-weight:bold;font-size:12pt;">${methodDetailVO.method}</textarea>
							</c:if>
								</c:forEach>
						</div>
